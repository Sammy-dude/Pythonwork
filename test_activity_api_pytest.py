...
def test_activity_api_pytest():
    ...
    # Pretty print the PUT payload
    print("PUT Payload:")
    print(json.dumps(put_payload, indent=4, sort_keys=True))

# If this script is meant to be used as a test script, you don't need to manually call pytest.main()
