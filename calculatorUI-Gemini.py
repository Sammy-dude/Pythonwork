...
def button_equal():
    ...
    if math == "addition":
        display.insert(tk.END, f_num + float(second_number))
...
# Create the display
display = tk.Entry(root, width=35, borderwidth=5, font=("Arial", 20))
...
button_equal = tk.Button(root, text="=", padx=84, pady=20, command=button_equal)
